...
class ProcessLogsSection(QVBoxLayout):
    def __init__(self, parent, configStore:ConfigStore, pipeline=None, call_update_cb=None):
        ...
        self.preset_selector = PresetSelector(self, self.cs, self.cs.r.process_logs.name)
        ...
        self.input_pattern_entry = StringConfigEntry(
            ...
            self.cs,
            "Input Pattern:",
            self.cs.r.process_logs.input_pattern
        )
        ...
        self.timestamp_format_entry = StringConfigEntry(
            ...
            self.cs,
            "Timestamp Format:",
            self.cs.r.process_logs.timestamp_format
        )
